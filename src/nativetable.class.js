import { NativetableCore } from './core/nativetable-core.class.js'
...
export class Nativetable {
  ...
  constructor(id, { sources = [], filters = {}, columns = [], pagination: { maxLength = -1 } = {}, sorting = false } = {}) {
    ...
    this.core = new NativetableCore({ sources, filters, columns, pagination: { maxLength }, sorting })
